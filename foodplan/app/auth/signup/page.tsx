...
export default function SignUpPage() {
  ...
  const handleGoogleSignUp = async () => {
    ...
    try {
      ...
      // Note: If successful, the browser will redirect to Google's OAuth page
        ...
        <div className="mt-8 space-y-6">
          ...
          <div className="text-center">
            <p className="text-sm text-gray-600 mb-4">
              Sign up with your Google account. If you're new, we'll create your account automatically.
            </p>
          </div>
