Use Chrome DevTools MCP to scrape food deals from https://etilbudsavis.dk/MENY and save the results as JSON to @sale/ with the date in the filename.
...
- Save to `sale/YYYY-MM-DD/meny_deals.json`
- Complete in ~30 seconds

**How to get publication ID**:
1. Visit https://etilbudsavis.dk/MENY
...
1. Navigate to https://etilbudsavis.dk/MENY
2. The website should open with the newest magazine automatically
3. If not, look for and click the button that says "Meny uge <newest-week-number>" (e.g., "Meny uge 46")
...
- **is_app_price**: Boolean - true if product requires Meny app for special price
...
Save the JSON output to: `sale/[YYYY-MM-DD]/meny_deals.json`

Where [YYYY-MM-DD] is today's date (e.g., sale/2025-11-02/meny_deals.json)
